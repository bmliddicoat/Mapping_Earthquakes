...
// Create a Third layer of the map
...
let overlays = {
  ...
  "Tetoninc": tetonicPlates,
  "Major Eathquake": majorEarthquakes
};
...
// Looping through our intervals to generate a label with a colored square for each interval.
 ...
 // Accesing the Tetonicplates GeoJson from Github
let dataTetonicplates = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json";
...
d3.json(dataTetonicplates).then(function(data) {
  L.geoJson(data, {
    style: tetonicPlatesstyle
  }).addTo(tetonicPlates);
